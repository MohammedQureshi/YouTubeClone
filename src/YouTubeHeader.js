    ...
    return (
        <div className="youtube__header">
            ...
            <div className="youtube__logo">
                ...
                <img src={YouTubeLogo} /><h3>YouTube</h3>
            </div>
            {/* Search Bar */}
            ...
            <div className="youtube__menu">
                ...
                <DashboardIcon />
                <NotificationsIcon />
                <img src="https://media-exp3.licdn.com/dms/image/C4E03AQF2s8dGWpgC5g/profile-displayphoto-shrink_800_800/0/1592998404125?e=1628726400&v=beta&t=tpzuv-7zuv8j5pny_nxEG_rjU6Q-_YrMz9Q1IJoKrto" />
            </div>
        </div>
    )
}
